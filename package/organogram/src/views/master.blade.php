...
<head>
    ...
    @include('organogrampkg::partials.google_analytics')
</head>
...
<div class="kt-header-mobile__toolbar">
    ...
    @include('organogrampkg::partials.profile.quick_profile')
</div>
    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
        <div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop"
            ...
            <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
                <div class="brand-logo m-auto master-brand-logo">
                    <a href="{{ url('dashboard') }}">
                        <img alt="Logo" src="{{ asset('assets/img/doptor-lg.png') }}" style="width:70%;"/>
                        <!-- <span style="font-size:15px!important;font-weight: bold;color: #5477ea;">N-Doptor</span> -->
                    </a>
                </div>
            ...
            <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
                @if (Auth::user()->user_role_id == config('menu_role_map.super_admin'))
                    @include('organogrampkg::partials.menu_aside')
                @else
                    @include('organogrampkg::partials.menu_aside')
                @endif
        ...
        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
            ...
            <div id="kt_header" class="kt-header kt-grid__item  kt-header--fixed " style="align-items: center;justify-content:end;">
                ...
                <!-- @include('organogrampkg::partials.topbar.welcome') -->
                <div class="kt-header__topbar">

                    <!--begin: Notification -->
                    @if (Auth::user()->user_role_id == config('menu_role_map.user'))
                        @include('organogrampkg::partials.topbar.notification')
                    @endif
                    @include('organogrampkg::partials.profile.quick_profile')
                </div>
            </div>
            <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor p-3" id="kt_content"
                ...
                @include('organogrampkg::partials.topbar.notification_bar')
                @yield('content')
            </div>
            @include('organogrampkg::partials.footer.footer')
        </div>
    </div>
</div>
...
<!-- begin::Quick Panel -->
{{-- @include('organogrampkg::partials.topbar.quick_panel') --}}
<!-- end::Quick Panel -->
...
<!--Begin:: Chat-->
{{-- @include('organogrampkg::partials.topbar.chat') --}}
<!--ENd:: Chat-->
