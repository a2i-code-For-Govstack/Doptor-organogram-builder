...
<div class="col-md-12 mt-2">
  <div class="card custom-card shadow-sm w-100">
    ...
    <div class="card-body">
      @if($employee_info->is_cadre == 0 || $employee_info->is_cadre == 2)
      <form onsubmit="changeToCadre(this, 'change_to_cadre'); return false;">
        <div class="row">
          ...
          <div class="col-md-2 d-flex align-items-end">
            <div class="form-group">
              <button id="makeCadre" class="btn btn-primary">কেডার </button>
            </div>
          </div>

        </div>
      </form>
      @elseif($employee_info->is_cadre == 1)
      <form onsubmit="changeToNonCadre(this, 'change_to_non_cadre'); return false;">
        <div class="row">
          <div class="col-md-2 d-flex align-items-end">
            <input type="hidden" value="{{$employee_info->id}}" name="employee_record_id">
            <div class="form-group">
              <button id="makeNonCadre" class="btn btn-primary">নন কেডার</button>
            </div>
          </div>
        </div>
      </form>
