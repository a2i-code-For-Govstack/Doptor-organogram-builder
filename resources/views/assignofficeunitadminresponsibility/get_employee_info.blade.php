        ...
        <tr class="text-center">
            <td>
                <input type="radio" name="office_admin" data-office_id="{{$current_responsible->office_id}}"
                       ...
                       @if($current_responsible->is_unit_admin == 1) checked @endif
                       data-office_unit_organogram_id="{{$current_responsible->id}}" onclick="assignUnitAdmin()">
            </td>
        ...
        <tr class="text-center">
            <td>
                <input type="radio" name="office_admin" data-office_id="{{$organogram->office_id}}"
                       id="office_unit_organogram_id"
                       @if($organogram->is_unit_admin == 1) checked @endif
                       data-office_unit_organogram_id="{{$organogram->id}}" onclick="assignUnitAdmin()">
            </td>
...
<script type="text/javascript">
    ...
    function assignUnitAdmin() {
        swal.fire({
            title: 'শাখা অ্যাডমিন দায়িত্ব পরিবর্তন করতে চান?',
            type: 'warning',
