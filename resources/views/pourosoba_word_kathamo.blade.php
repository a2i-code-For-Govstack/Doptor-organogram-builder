...
@section('content')
    <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
        ...
        <div class="sna-subheader py-2 py-lg-6 subheader-solid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap" id="kt_subheader">
            ...
            <div class="ml-3"></div>
            <div>
                <h3 class="text-white my-1">প্রশাসনিক বিভাগ থেকে পৌরসভা ওয়ার্ড</h3>
            </div>
                    ...
                    <div class="card custom-card round-0 shadow-sm">
                        <div class="card-body">
                            <div id="kt_tree_2" class="tree-demo">
                                {!! loadTree($results, 'zila_kathamo->upozila_kathamo->pouroshova_kathamo->pouroshova_word_kathamo') !!}
                            </div>
                        </div>
                    </div>
                </div>
