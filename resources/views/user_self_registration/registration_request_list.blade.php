...
@section('content')
    <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor sna-common-content-border"
        ...
        <div
            ...
            <div>
                <h3 class="text-white my-1">নিবন্ধন অনুরোধ তালিকা</h3>
            </div>
        ...
        <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid p-3">
            ...
            <div class="row mb-2">
                <div class="col-md-12">
                    <div style="display:none" class="card custom-card shadow-sm w-100 advance_search ">
                        ...
                        <div class="card-body">
                            <form onsubmit="searchData(this, 'search_registrations'); return false;">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input id="name_bng" class="form-control rounded-0" type="text"
                                                   placeholder="নাম(বাংলা)" name="name_bng">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input id="nid" class="form-control rounded-0" type="text"
                                                   placeholder="জাতীয় পরিচয় পত্র নম্বর" name="nid">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input id="personal_mobile" class="form-control rounded-0" type="text"
                                                   placeholder="মোবাইল নম্বর" name="personal_mobile">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input id="personal_email" class="form-control rounded-0" type="text"
                                                   placeholder="ইমেইল" name="personal_email">
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="kt-portlet__body">
                <div id="list_div" class="load-table-data" data-href="/get_registration_request_list">
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', ".btntableDataEdit", function () {
            ...
            $(".kt_quick_panel__title").text('নিবন্ধন তথ্য');
            $("#kt_quick_panel").addClass('kt-quick-panel--on');
            $("#kt_quick_panel").css('opacity', 1);
            $("html").addClass("side-panel-overlay");
        });
