...
@section('content')
    <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor sna-common-content-border" id="kt_content">
        ...
        <div class="sna-subheader py-2 py-lg-6 subheader-solid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap" id="kt_subheader">
            ...
            <div class="ml-3"></div>
            <div>
                <h3 class="text-white my-1">head of Office Branch Admin Responsibility</h3>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card custom-card round-0">
                        <div class="card-body">
                            ...
                            <x-office-select unit="true" grid="3"/>
    ...
    <script !src="">
        $("select#office_unit_id").change(function () {
            office_unit_id = $(this).children("option:selected").val();
            loadOfficeUnitUsers(office_unit_id);
        });

        function loadOfficeUnitUsers(office_unit_id) {
            url = 'load_office_unit_wise_users';
            data = {office_id: $("#office_id").val(), office_unit_id: $("#office_unit_id").val()};
            datatype = 'html';
