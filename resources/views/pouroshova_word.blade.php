...
@section('content')
    <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor sna-common-content-border"
        ...
        <div
            ...
            <div>
                <h3 class="text-white my-1">পৌরসভা ওয়ার্ডের তালিকা</h3>
            </div>
        ...
        <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid p-3">
            <div class="row mb-2">
                <div class="col-md-12">
                    <div style="display:none" class="card custom-card shadow-sm w-100 advance_search">
                        ...
                        <div class="card-body">
                            <form onsubmit="searchData(this, 'search_pouroshova_word'); return false;">
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input id="name_en" class="form-control rounded-0" type="text"
                                                   name="name_en" placeholder="ওয়ার্ডের নাম(ইংরেজি)">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input id="name_bn" class="form-control rounded-0" type="text"
                                                   name="name_bn" placeholder="ওয়ার্ডের নাম(বাংলা)">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input id="pouroshova_word_code"
                                                   class="form-control rounded-0 bijoy-bangla integer_type_positive"
                                                   type="text" name="pouroshova_word_code" placeholder="ওয়ার্ড কোড"
                                                   style="font-size: 14px;">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <select name="pouroshova_word_status" id="pouroshova_word_status"
            ...
            <div class="kt-portlet__body">
                <div id="list_div" class="load-table-data" data-href="/getPouroshovaWord"></div>
            </div>
            <div class="row">
            </div>
        </div>
        ...
        <div class="kt-quick-panel__content">
            <div class="mt-3">
                <form id="pouroshova_word_form"
                      onsubmit="submitData(this, '{{route('pouroshova_word.store')}}'); return false;">
                    <div class="col-md-12">
                        <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input id="ward_name_bng" class="form-control rounded-0" type="text" name="ward_name_bng"
                                   required>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input id="ward_name_eng" class="form-control rounded-0" type="text" name="ward_name_eng"
                                   required>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="bbs_code">পৌরসভা ওয়ার্ড BBS কোড</label><span class="text-danger">*</span>
                    ...
                    <input type="hidden" id="pouroshovaword_id" name="id">
    ...
    <script type="text/javascript">
        ...
        $(".create-posasonik").click(function () {
            ...
            $('.kt_quick_panel__title').text('পৌরসভা ওয়ার্ড');
        ...
        $(document).on('click', ".btntableDataEdit", function () {
            ...
            $(".kt_quick_panel__title").text('পৌরসভা ওয়ার্ড সম্পাদন');
            $("#kt_quick_panel").addClass('kt-quick-panel--on');
            $("#kt_quick_panel").css('opacity', 1);
            $("html").addClass("side-panel-overlay");
            ...
            loadPouroshova(geo_upazila_id, geo_pouroshova_id);
            if (geo_upazila_id) {
        ...
        $("select#geo_division_id").change(function () {
            ...
            $('#division_bbs_code').val(division_code);
            var geo_district_id = $('#geo_district_id').val();
            // $('#division_bbs_code').val(division_code);
        ...
        $("select#geo_district_id").change(function () {
            ...
            $('#district_bbs_code').val(district_code);
            var geo_upazila_id = $('#geo_upazila_id').val();
            // $('#division_bbs_code').val(division_code);
            loadUpoZila(district_id, geo_upazila_id);
        });
        ...
        $("select#geo_upazila_id").change(function () {
            ...
            var geo_district_id = $('#geo_district_id').val();
            // $('#division_bbs_code').val(division_code);
            loadPouroshova(upozila_id, geo_district_id = '');
        });
        ...
        $('#btn_excel_generate').on('click', function () {
            var url = 'generate_pouroshova_word_excel_file';
            var data = {};
            var datatype = 'json';
