            ...
            <div class="kt-portlet kt-portlet--mobile">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        <button id="btn-advance-search" type="button" class="btn btn-default btn-icon-sm dropdown-toggle">অনুসন্ধান
                        </button>
                    </div>
...
{{--                                        </li>--}}
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <select id="office_ministry_id" name="office_ministry_id" class="form-control rounded-0">
                                                <option selected="" value="">--মন্ত্রণালয় বাছাই করুন--</option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <select  id="office_layer_id" name="office_layer_id" class="form-control rounded-0">
                                                <option selected="" value="0">--মন্ত্রণালয়/বিভাগ বাছাই করুন--</option>
                                      ...
                                      <div class="col-md-4">
                                        <div class="form-group">
                                            <select name="office_origin" id="office_origin_id"
                                                ...
                                                <option selected="" value="0">--দপ্তর / অধিদপ্তরের ধরন বাছাই করুন--</option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <select id="office_id" name="office_id" class="form-control rounded-0">
                                                <option selected="" value="">--অফিস বাছাই করুন--</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <input placeholder="নাম (বাংলা)" id="name_bn" class="form-control rounded-0" type="text" name="name_bn">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <input placeholder="লগইন আইডি" id="login_id" class="form-control rounded-0" type="text" name="login_id">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <input placeholder="জাতীয় পরিচয়পত্র নাম্বার" id="emp_nid" class="form-control rounded-0" type="text" name="emp_nid">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <input placeholder="ইমেইল" id="emp_email" class="form-control rounded-0" type="text" name="emp_email">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <input placeholder="মোবাইল" id="emp_mobile" class="form-control rounded-0" type="text" name="emp_mobile">
                                        </div>
                                    </div>
            ...
            <div class="kt-portlet__body">
                <div class="row mt-3">
                    <div id="list_div" class="load-table-data" data-href="/get_wating_employeerecord_data"></div>
                </div>
            </div>
